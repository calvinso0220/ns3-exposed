...
class MgtHelloHeader : public Header {
public:
	MgtHelloHeader();
	~MgtHelloHeader();

	NeighborAPInformation GetNeighborAPInformation (void) const;
	void SetNeighborAPInformation(NeighborAPInformation aps);
