...
//NETSYS
	void PrintNeighborStatus(void);
	void SetHelloGeneration(bool enable);
	bool GetHelloGeneration(void) const;
...
//NETSYS
	...
	bool m_enableHelloGeneration;
	EventId m_helloEvent;
	Ptr<UniformRandomVariable> m_helloJitter;
	bool m_enableHelloJitter;

	virtual void DoDispose(void);
	virtual void DoInitialize(void);

	Ptr<NeighborInfoManager> m_neighborManager;
