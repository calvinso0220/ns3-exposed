...
int main (int argc, char *argv[])
{
  ...
  std::cout << "wifiType: " << wifiType << " distance: " << distance << "m; sent: 1000 TxPower: 20 dBm" << std::endl;
  ...
  for (uint16_t i = startIndex; i <= stopIndex; i++)
    {
      ...
      if (wifiType == "ns3::YansWifiPhy")
      ...
      else if (wifiType == "ns3::SpectrumWifiPhy")
        {
          ...
          spectrumPhy.Set ("TxPowerStart", DoubleValue (20.0)); // dBm  (1.26 mW)
