...
int main(int argc, char *argv[]) {
    ...
    phy.Set("EnergyDetectionThreshold", DoubleValue(-42.0));	// Default is -96dBm
    phy.Set("CcaMode1Threshold", DoubleValue(-42.0));			// Default is -99dBm
    ...
    myClientB.SetAttribute("Interval", TimeValue(Seconds(0.0001)));
